...
<div class="card-feature p-6">
    ...
    <div class="overflow-x-auto"><table class="w-full">
        <thead><tr class="border-b border-[var(--color-hairline-soft)]">
            ...
            <th class="pb-3 pr-4 text-left table-header">HP</th><th class="pb-3 text-left table-header">{{ __('messages.status') }}</th>
        </tr></thead><tbody>
        @forelse($recentRepairs as $r)
        @php $sc=['received'=>'badge-info','in_progress'=>'badge-attention','waiting_for_parts'=>'badge-warning','completed'=>'badge-success','canceled'=>'badge-critical','picked_up'=>'badge-neutral']; @endphp
        <tr class="border-b border-[var(--color-hairline-soft)]/50">
            ...
            <td class="py-3 pr-4 type-body-sm text-[var(--color-slate)]">{{ $r->phone_brand }} {{ $r->phone_model }}</td>
