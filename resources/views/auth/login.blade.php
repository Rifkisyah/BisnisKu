...
<head>
    ...
    <title>{{ __('Log in') }} - BisnisKu</title>
    <!-- Fonts -->
...
<div class="flex min-h-screen">
    ...
    <div class="hidden w-1/2 lg:flex items-center justify-center bg-[var(--color-surface-soft)] p-16">
        <div class="text-center max-w-lg">
            ...
            <h1 class="type-display text-[var(--color-ink-deep)]">BisnisKu</h1>
            <p class="mt-4 type-subtitle-md text-[var(--color-slate)]">{{ __('BisnisKu is the all-in-one Point of Sale and management platform. Designed for speed, built for growth, and powered by smart algorithms.') }}</p>
